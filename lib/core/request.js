...
module.exports = {
	...
	get id() {
		if (this._id) {
			...
			this.app.logger.warn('未在API网关配置参数，无法获取参数 request.id 。配置方式请参考文档说明，如不需要使用该参数，可忽略本条提醒。')
			return ''
		}
	},
	...
	get ua() {
		if (this._ua) {
			...
			this.app.logger.warn('未在API网关配置参数，无法获取参数 request.ua 。配置方式请参考文档说明，如不需要使用该参数，可忽略本条提醒。')
			return ''
		}
	},
